...
# Run the conversion
/Users/tianli/miniforge3/bin/python3 /Users/tianli/bendownloads/docx_styler/main.py "$SELECTED_FILE"

# Show success notification
echo "✅ Converted $(basename "$SELECTED_FILE") to docx in $(basename "$FILE_DIR")"
