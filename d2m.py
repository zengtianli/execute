...
if [ $# -eq 0 ]; then
    ...
    for docx_file in *.docx; do
        ...
        if [ -e "$docx_file" ]; then
            ...
            /Users/tianli/miniforge3/bin/python3 /Users/tianli/bendownloads/mark_docx/src/docxmark_1.py "$docx_file"
    ...
    /Users/tianli/miniforge3/bin/python3 /Users/tianli/bendownloads/mark_docx/src/docxmark_1.py "$@"
    # Get the input file name without extension
    input_file="${1%.*}"
    # Cat the generated markdown file if it exists
